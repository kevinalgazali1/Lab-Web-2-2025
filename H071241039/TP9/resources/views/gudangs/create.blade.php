...
<head>
    ...
    <title>Tambah Gudang - Sistem Manajemen Produk</title>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p class="text-gray-600">Tambahkan gudang penyimpanan baru</p>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="lokasi" id="lokasi" rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                      placeholder="Masukkan lokasi gudang (opsional)">{{ old('lokasi') }}</textarea>
                            @error('lokasi')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex justify-end space-x-3 pt-4">
                            ...
                            <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-200">
                                <i class="fas fa-save mr-2"></i>Simpan Gudang
                            </button>
                        </div>
                    </div>
                </form>
