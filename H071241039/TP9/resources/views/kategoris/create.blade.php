...
<head>
    ...
    <title>Tambah Kategori - Sistem Manajemen Produk</title>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p class="text-gray-600">Tambahkan kategori produk baru</p>
                    </div>
                    <a href="{{ route('kategoris.index') }}" class="text-gray-500 hover:text-gray-700 transition duration-200">
                ...
                <form action="{{ route('kategoris.store') }}" method="POST">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-end space-x-3 pt-4">
                            <a href="{{ route('kategoris.index') }}" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition duration-200">
                                Batal
                            </a>
