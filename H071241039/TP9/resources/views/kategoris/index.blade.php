...
<head>
    ...
    <title>Manajemen Kategori - Sistem Manajemen Produk</title>
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-600">Kelola kategori produk Anda</p>
            </div>
            <a href="{{ route('kategoris.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center transition duration-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                <a href="{{ route('kategoris.show', $kategori) }}" class="text-blue-600 hover:text-blue-900 transition duration-200" title="Lihat">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('kategoris.edit', $kategori) }}" class="text-green-600 hover:text-green-900 transition duration-200" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('kategoris.destroy', $kategori) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="text-red-600 hover:text-red-900 transition duration-200" title="Hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus kategori ini?')">
